...
INSERT INTO ticket (id, category, description, cost)
VALUES (UNHEX(REPLACE(UUID(), '-', '')), 'Speeding', 'Exceeded speed limit by 20 mph', 150.00);
INSERT INTO ticket (id, category, description, cost)
VALUES (UNHEX(REPLACE(UUID(), '-', '')), 'Red Light Violation', 'Crossed the intersection after the light turned red', 200.00);
INSERT INTO ticket (id, category, description, cost)
VALUES (UNHEX(REPLACE(UUID(), '-', '')), 'Illegal Parking', 'Parked in a no-parking zone', 100.00);
INSERT INTO ticket (id, category, description, cost)
VALUES (UNHEX(REPLACE(UUID(), '-', '')), 'Distracted Driving', 'Texting while driving', 250.00);
INSERT INTO ticket (id, category, description, cost)
VALUES (UNHEX(REPLACE(UUID(), '-', '')), 'Seatbelt Violation', 'Driver not wearing a seatbelt', 120.00);
INSERT INTO ticket (id, category, description, cost)
VALUES (UNHEX(REPLACE(UUID(), '-', '')), 'Failure to Stop at a Stop Sign', 'Did not come to a complete stop at the stop sign', 180.00);
INSERT INTO ticket (id, category, description, cost)
VALUES (UNHEX(REPLACE(UUID(), '-', '')), 'Expired License', 'Driving with an expired license', 300.00);
INSERT INTO ticket (id, category, description, cost)
VALUES (UNHEX(REPLACE(UUID(), '-', '')), 'Reckless Driving', 'Swerving in and out of lanes', 400.00);
INSERT INTO ticket (id, category, description, cost)
VALUES (UNHEX(REPLACE(UUID(), '-', '')), 'Improper Lane Change', 'Changing lanes without signaling', 160.00);
INSERT INTO ticket (id, category, description, cost)
VALUES (UNHEX(REPLACE(UUID(), '-', '')), 'Driving Under the Influence', 'Caught driving while intoxicated', 500.00);
